...
var Popover = function (_React$Component) {
  ...
  function Popover(props) {
    ...
    _this.getTargetNodeRef = function (targetWrapperEl) {
      Object.assign(_this, {
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      return [_react2.default.createElement(
        "div",
        { key: "1", ref: this.getTargetNodeRef },
        this.props.children
      ), !_platform.isServer && _reactDom2.default.createPortal(popover, this.props.appendTarget)];
    }
  }]);
...
Popover.defaultProps = {
  ...
  appendTarget: _platform.isServer ? null : _platform.document.body
};
